...
dir_name = '/Volumes/Extreme SSD/tumura/gantei5/'
files = glob.glob(dir_name+'*.tiff')
OUTPUT_DIR='/Users/masayakinefuchi/imageSensing/IR_pulse/_skinColorSeparation/result/'
subject ='gantei5'
...
for f in files[0:331]:
    ...
    ##ROI
    pulsewave[i] = np.mean(img[roi[1]:roi[1]+height,roi[0]:roi[0]+width,:])
